...
public class PrintTTCFileTemplate {
      ...
      while ((line = in.readLine()) != null) {
         ...
         if (line.split(" ").length > 0) {
            if (line.split(" ")[0].equals("include")) {
               ...
               System.out.println("Including " + malFolder + "/" + includedMalFile);
   ...
   public static void writeTTCConfigFile(String configFilePath, String malFolder, String malFile) {
      ...
      System.out.println("Attempting to write the TTC Config File " + configFilePath + " based on " + malFolder + "/" + malFile);
      try {
